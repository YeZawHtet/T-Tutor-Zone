                ...
                <div class="table-responsive">
                  <table id="datatable" class="table data-table table-striped">
                    ...
                    <tbody>
                      ...
                      $qry = "select p.*, t.TutorName, c.ChargeType, c.Amount from Payment p, Tutor t, Charge c Where t.TutorID=p.TutorID And p.ChargeID=c.ChargeID and ExpireDate='Null'";
                      $num = 1;
                          ...
                          <td>
                            <form method="get" action="ManagePayment.php">
                              <div class="flex align-items-center list-user-action">
                                <a class="btn btn-sm bg-primary" data-toggle="tooltip" data-placement="top" data-original-title="Confirm" href="ManagePaymentU.php?paymentupID=<?php echo $row['PaymentID']; ?>"><i class="ri-pencil-line mr-0"></i></a>
