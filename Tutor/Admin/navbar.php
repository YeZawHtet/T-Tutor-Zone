                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                      ...
                                      <?php 
                                        ...
                                        $q="select * from admin where AdminID=1";
                                        $res=mysqli_query($con, $q);
                                        $row=mysqli_fetch_assoc($res);
                                      ?>
                                      <img src="../assets/images/user/naim-ahmed-8BcVHmAHtlw-unsplash.jpg" class="rounded-circle" alt="user">
                                      <div class="caption ml-3">
                                          <h6 class="mb-0 line-height"><?php echo $row['Username'];?> <i class="las la-angle-down ml-2"></i></h6>
                                      </div>
                                  </a>                            
