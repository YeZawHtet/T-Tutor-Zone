                        ...
                        <div class="card">
                           <div class="card-header d-flex justify-content-between">
                             <div class="iq-header-title">
                                 <h4 class="card-title"><?php echo $row['Username'];?>'s Information</h4>
                              </div>
                           </div>
                           <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                       <div class="profile-img-edit">
                                          <div class="crm-profile-img-edit">
                                             <img class="crm-profile-pic rounded-circle avatar-100" src="../assets/images/user/naim-ahmed-8BcVHmAHtlw-unsplash.jpg" alt="profile-pic">
                                          </div>                                          
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <?php 
                                if(isset($_POST['prosubmit'])){
                                    ...
                                    $phone=$_POST['phone'];
                                    $nrc=$_POST['nrc'];
                                    $res=mysqli_query($con, "update Admin set Username='$name', Email='$email', Phone='$phone', NRC='$nrc'");
                           ...
                           <div class="card-body">
                              <form method="post">
                                 <div class="form-group">
                                    ...
                                    <input type="Password" class="form-control" id="cpass" name="curpassword" value="">
                                 </div>
                                 <div class="form-group">
                                    <label for="npass">New Password:</label>
                                    <input type="Password" class="form-control" id="npass" name="npassword" value="">
                                 </div>
                                 <div class="form-group">
                                    <label for="vpass">Verify Password:</label>
                                    <input type="Password" class="form-control" id="vpass" value="" name="vpassword">
                                 </div>
                              ...
                              <?php if(isset($_POST['passsubmit'])){
                                ...
                                if($currentPassword==$password){
                                    if($newPassword==$verifyPassword){
                                        $res=mysqli_query($con,"Update admin Set Password='$newPassword' Where AdminID=$AdminID");
                                        echo "<script> alert('Successfully Changed to New Password'); </script>";
                                    }
                                    else{
