...
if (isset($_POST['adminlogin'])) {
  ...
  if ($row > 0) {
    $_SESSION['AdminID'] = $retri['AdminID'];
    echo '<script>
                alert("Login Successful"); location.assign("AdminDashboard.php");
              </script>';
  } else {
    echo '<script>
        alert("Login Fail");;
                    ...
                    <div class="p-3">
                      ...
                      <form method="post">
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <a href="Forgot.php" class="text-white float-right">Forgot Password?</a>
                          </div>
                        </div>
                        <button type="submit" name="adminlogin" class="btn btn-white">Sign In</button>
                      </form>
                    </div>
                  </div>
