                        ...
                        <div class="card">
                           <div class="card-header d-flex justify-content-between">
                             <div class="iq-header-title">
                                 <h4 class="card-title"><?php echo $row['PaName'];?>'s Information</h4>
                              </div>
                           </div>
                           <div class="card-body">
                              <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                       <div class="profile-img-edit">
                                          <div class="crm-profile-img-edit">
                                             <img class="crm-profile-pic rounded-circle avatar-100" src="../assets/images/parent/<?php echo $row['ParentImage'];?>" alt="profile-pic">
                                 ...
                                 <div class=" row align-items-center">
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" name="name" class="form-control" id="name" value="<?php echo $row['PaName'];?>">
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" name="city" class="form-control" id="nrc" value="<?php echo $row['PaCityName'];?>">
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="dob">NRC:</label>
                                       <input type="text" name="nrc" class="form-control" id="dob" value="<?php echo $row['NRC'];?>">
                                    </div>
                                 </div>
                              ...
                              <?php 
                                if(isset($_POST['prosubmit'])){
                                    ...
                                    if($tmp==null){
                                        $res=mysqli_query($con, "update parent set PaName='$name', Email='$email', Phone='$phone', PaCityName='$city', NRC='$nrc' where PaID=$paID");
                                        echo "<script> alert('Updated Information'); location.assign('EditProfile.php');</script>";
                                    }else{
                                    $res=mysqli_query($con, "update parent set PaName='$name', Email='$email', Phone='$phone', PaCityName='$city', NRC='$nrc', ParentImage='$image' where PaID=$paID");
                                    move_uploaded_file($tmp, '../assets/images/parent/' . $image);
                                    echo "<script> alert('Updated Information'); location.assign('EditProfile.php');</script>";
                           ...
                           <div class="card-body">
                              <form method="post">
                                 <div class="form-group">
                                    ...
                                    <a href="../Admin/Forgot.php" class="float-right">Forgot Password</a>
                              ...
                              <?php if(isset($_POST['passsubmit'])){
                                ...
                                if($currentPassword==$password){
                                    if($newPassword==$verifyPassword){
                                        $res=mysqli_query($con,"Update parent Set Password='$newPassword' Where PaID=$parentID");
