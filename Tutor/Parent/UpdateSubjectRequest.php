        ...
        <div class="row">
          <div class="col-sm-4 col-lg-4">
            ...
            if (isset($_POST['updateSubjectRequest'])) {
              ...
              $re = mysqli_query($con, "select * from subjectrequest where SubjectName='$subjectName' and SubjectRequestID=$reqsubID");
              $c = mysqli_num_rows($re);
              if ($c) {
                echo "<script>alert('Already Exist!'); location.assign('ManageSubject.php');</script>";
              } else {
