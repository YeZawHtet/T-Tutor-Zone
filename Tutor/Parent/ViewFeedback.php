...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Parent View Feedback</title>
            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     $qr=mysqli_fetch_assoc(mysqli_query($con, "select Email from parent where PaID = $parentID"));
                     $email=$qr['Email'];
                     $q=mysqli_query($con, "select * from rating where Email='$email'");
